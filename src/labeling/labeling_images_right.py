...
image = cv2.imread("../../data/processed/right/right_" + args["image"] + '.jpg')
cv2.namedWindow("image")
cv2.setMouseCallback("image", click_and_crop)

h, w = image.shape[0], image.shape[1]

file_path = 'right_' + args["image"] + '.jpg'
...
while True:
    ...
    for point_circle in all_points:
        cv2.circle(image, point_circle, radius=5, color=(0, 255, 0), thickness=-1)
